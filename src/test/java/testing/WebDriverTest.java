...
public static ThreadLocal<BrowserInstance> browser=new ThreadLocal<>();

private ScreenRecorder screenRecorder;

public synchronized void beforeClassTest(@Optional(DEFAULT_BROWSER) String browserType) throws IOException {
...
//       driver= ;
    ...
    public static BrowserInstance driver;

public synchronized void tearClassTest(){
   try{
